...
classes and objects in our defined language (\verb'OBJ'),
using classes and objects in our defining language (Java).
This can be confusing.
For example, a \verb'ClassExp' evaluates to an object in Java
that represents a class in our defined language.
