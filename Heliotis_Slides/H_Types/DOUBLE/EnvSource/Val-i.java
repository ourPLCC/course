...
public interface Val {
    ...
    /**
     * Return an double value from this Val, if appropriate.
     * @excep RunTimeException if this is not a double value.
     */
    public default double doubleVal() {
        throw new RuntimeException(
                        "doubleVal(): this Val is not a DoubleVal." );
    }
